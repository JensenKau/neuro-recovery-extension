...
class PatientConnectivityData:
    ...
    def __init__(self, avg_fc: NDArray, std_fc: NDArray) -> None:
        self.avg_fc = avg_fc
        self.std_fc = std_fc
    ...
    def load_patient_connectivity(cls, eeg_data: PatientEEGData) -> PatientConnectivityData:
        ...
        avg_fc, std_fc = PatientConnectivityData.gnerate_fc(organized_data, sampling_frequency)
        
        return PatientConnectivityData(avg_fc, std_fc)
    ...
    @classmethod
    def gnerate_fc(cls, eeg_data: NDArray, sampling_frequency: int) -> Tuple[NDArray, NDArray]:
        sample_size = 60
