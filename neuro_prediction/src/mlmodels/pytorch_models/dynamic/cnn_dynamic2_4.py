...
class CnnDynamic2_4(DynamicModel):
    class InternalModel(nn.Module):
        def __init__(
            ...
            dimension3_2 = dimension3_1 - (kernel3_2 - 1)
            dimension3_2 = math.floor(((dimension3_2 - (pool3_1 - 1) - 1) / pool3_1) + 1)
            linear_size = dimension3_2 * output_chn3_2
            ...
            joined_layers = [
                ...
                nn.Conv1d(output_chn3_1, output_chn3_2, kernel3_2),
    ...
    def __init__(self) -> None:
        super().__init__("cnn_dynamic_2_4", self.InternalModel)
    ...
    def objective(self, trial: Trial, dataset: List[PatientData]) -> BaseMLModel:
        ...
        output_chn3_2 = trial.suggest_int("output_chn3_2", 2, 40)
        kernel3_2 = trial.suggest_int("kernel3_2", 2, 10)
